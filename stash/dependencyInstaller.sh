...
##
## Wrote this back around 2013 to install dependencies
##
## Originally written: 2013
## See: https://gist.github.com/WebPlatformDocs/01c09df78f05612c281f#file-wpd-dependency-installer-sh
## Time Spent: ~
##
...
##
depFiles=( $(find . -maxdepth 4 -type f -regex ".*\(\(package\|composer\|bower\)\.json\|Gemfile\|\.gitmodules\)") )
...
#depFiles+=('./wiki/repo/mediawiki/extensions/WebPlatformDocs/composer.json')
#depFiles+=('./wiki/repo/mediawiki/extensions/WebPlatformAuth/composer.json')
